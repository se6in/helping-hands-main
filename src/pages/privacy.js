...
function Privacy() {
  ...
  return (
      <div id ="privacy_back">
          ...
          &emsp;<img src={change_name} style={{ width: 25, height: 25 }} alt='사람' />
                  &emsp;&emsp;
                  이름 변경
          ...
          &emsp;<img src={change_agency} style={{ width: 25, height: 25 }} alt='사람' />
                  &emsp;&emsp;
                  봉사 단체 변경
          ...
          &emsp;<img src={change_profile} style={{ width: 25, height: 25 }} alt='사람' />
                  &emsp;&emsp;
                  프로필 사진 변경
                  &nbsp;&emsp;&emsp;&emsp;&emsp;
                  <img src={rightarrow} style={{ width: 20, height: 20 }} alt='화살표' />
